...
BUILD_ROOT = Path('E:/GameDev/Builds/HarborCity/M5_VS2').resolve()
...
def main():
    ...
    require(manifest.get('status') == 'PASS' and manifest.get('milestone') == 'M5_VS2', 'A successful M5 package is required')
    ...
    require(cook.is_relative_to((WORK / 'docs/HarborCity_M5_VS2/package_work').resolve()), 'Crypto cache must belong to private M5 Cook work')
